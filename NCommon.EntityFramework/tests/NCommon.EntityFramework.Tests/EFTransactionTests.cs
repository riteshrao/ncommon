...
namespace NCommon.Data.EntityFramework.Tests
{
    ...
    {
        [Test]
        public void Commit_commits_all_IDbTransaction_transactions_handled_by_EFTransaction()
        {
            var tx = new EFTransaction(IsolationLevel.ReadCommitted);
        ...
        public void Dispose_calls_dispose_on_all_NHibernate_transactions_handled_by_NHTransaction()
        {
            var nhTx1 = MockRepository.GenerateMock<IDbTransaction>();
            var nhTx2 = MockRepository.GenerateMock<IDbTransaction>();
            using (var tx = new EFTransaction(IsolationLevel.ReadCommitted, nhTx1, nhTx2))
            {
            }
        ...
        public void Commit_Raises_TransactionComitted_Event()
        {
            ...
            var transaction = new EFTransaction(IsolationLevel.Serializable);
