...
namespace NCommon.Data.LinqToSql.Tests
{
    ...
    /// </summary>
    [TestFixture]
    public class LinqToSqlRepositoryTests : LinqToSqlTestBase
    {
        [Test]
        ...
        public void Save_Updates_Existing_Order_Record()
        {
            ...
            using (var testData = new LinqToSqlDataGenerator(OrdersContextProvider()))
            {
        ...
        {
            using (var ordersDomainTestData = new LinqToSqlDataGenerator(OrdersContextProvider()))
            using (var hrDomainTestData = new LinqToSqlDataGenerator(HRContextProvider()))
            {
                ...
                {
                    var customerRepository = new LinqToSqlRepository<Customer>();
                    var salesPersonRepository = new LinqToSqlRepository<SalesTerritory>();
